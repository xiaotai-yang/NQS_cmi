...
for i in angle_list:
    ...
    if i == 0:
        meanE_cluster_TQS_p2.append(np.load(f"result/oneDTQS/meanE_1DTQS_Htypecluster_L32_patch2_layer2_ff512_units64_head4_batch256_dmrgFalse_seed3_angle{i}.npy").tolist())
        evalE_cluster_TQS_p2.append(np.load(f"result/oneDTQS/evalmeanE_1DTQS_Htypecluster_L32_patch2_layer2_ff512_units64_head4_batch256_dmrgFalse_seed3_angle{i}.npy").tolist())
    else:
